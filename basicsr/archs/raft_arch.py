...
class RAFT(nn.Module):
    def __init__(self,
        ...
        param_dict = torch.load('/data0/ltl/code/BasicSR_pro/modelzoo/flowuse/raft-chairs.pth', map_location=lambda storage, loc: storage)
...
if __name__ == '__main__':
    h, w = 256, 256
    # model = RAFT().cuda()
    model = FlowGenerator(load_path='../../experiments/pretrained_models/RAFT/raft-small.pth').cuda()
    model.eval()
    print(model)
