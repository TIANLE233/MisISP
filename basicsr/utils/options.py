...
def parse_options(root_path, is_train=True):
    ...
    parser.add_argument('-path_arch', type=str, required=True, help='Path to experiment YAML file.')
    parser.add_argument('-path_model', type=str, required=True, help='Path to experiment YAML file.')
    parser.add_argument('-path_data', type=str, required=True, help='Path to experiment YAML file.')
