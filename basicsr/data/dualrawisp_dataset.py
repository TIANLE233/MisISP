...
class DUALRAWISP4(data.Dataset):  # 暂停bit0的使用
    def __init__(self, opt) -> None:
        super(DUALRAWISP4, self).__init__()
...
@DATASET_REGISTRY.register()
class DUALRAWISP4_noise(data.Dataset):  # 暂停bit0的使用
    def __init__(self, opt) -> None:
        super(DUALRAWISP4_noise, self).__init__()
